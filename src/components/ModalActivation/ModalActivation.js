...
export default function ModalActivation({
  ...
  return (
    <Modal animationType="slide" transparent={true} visible={hidden > 0}>
      <TouchableWithoutFeedback
              ...
              <View style={styles.content}>
                ...
                >
                  ...
                  {hidden == 1 && (
                    <>
                      <Text style={styles.text__info}>
                        Hemos enviado el código de activación al número de
                        celular
                      </Text>
                      <View style={styles.content__info}>
                        {phone && (
                          <Text style={styles.text__data}>{phone}</Text>
                        )}
                      </View>
                      <View style={styles.lineStyle} />
                      <Text style={styles.text__activation}>
                        {" "}
                  ...
                  {hidden == 2 && (
                    <>
                      <Text style={styles.text__info}>
                        Hemos enviado un código de activación a tu correo
                        electrónico
                      </Text>
                      <View style={styles.content__info}>
                        {email && (
                          <Text style={styles.text__data}>{email}</Text>
                        )}
                      </View>
                      <View style={styles.lineStyle} />
                      <Text style={styles.text__activation}>
                  ...
                  {hidden == 3 && (
                    <>
                      <Text style={styles.text__info}>
                        Hemos enviado un código de activación al número de
                        celular
                      </Text>
                      <View style={styles.content__info}>
                        {phone && (
